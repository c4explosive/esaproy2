...
void menu2( int * array);
void menu3( int * array);
int * burbuja1 (int * array, int o);
int * inserccion1(int * array, int o);
void menu();
void menu1(int *array);
void print();
...
{
    int n,cont=1;//declaración de variables
...
{
    case 1:
	     menu2(array);//llamada de la función que contiene el submenú del burbuja
	     getch();
	      break;
   case 2:

	    menu3(array);//llamada de la función que contiene el submenú insercion
	   getch();
	  break;
...
int * burbuja1 (int * array, int o) //en este método o función se reciben dos parámetros, uno que es la array a modificar y el otro que dice el tipo de orden que va manejar. Sea ascendente o descendente.
{
    int i,j,aux,mode; //Se declaran cuatro variables, i y j para contadores; aux para trabajar un intercambio y mode que es lo que decide si el se compara para orden descendente o descendente según la variable o.
    for(i=0;i<TAM;i++) //En estos bucles se comienza a comparar un elemento con todos.
    {
...
void menu2( int * array)//menu de BURBUJA
{
  int n,u=0, cont=1;
  ...
  switch(n)
     {
      case 1://está primera opción permite ordenar los número de mayor a menor
	     ...
	     array=burbuja(array,1);//llamada de la función que ordena los números de mayor a menor
       ...
       case 2://está segunda opción permite ordenar los número de menor a mayor
	     printf("Menor a mayor\n");
             print(array);//imprime el arreglo desordenado
	     array=burbuja1(array,1);//llamada de la función que ordena los números de menor a mayor
	     print(array);//imprime el arreglo ordenado
	     u=0;
             break;
...
int * inserccion1(int * array, int o) //Lo mismo que en los demás métodos, se recibe un array (arreglo) y un indicador de la forma a ordenar.
{
    int i,j,m,elem,mode;
    for (i=0;i<TAM-1;i++) //Muy similar al método burbuja, se comienza con un bucle principal.
    {
...
void menu3( int * array)//menu de insercion
{
  int n,u=0, cont=1;
  ...
  switch(n)
     {
      case 1://está primera opción permite ordenar los número de mayor a menor
	     ...
	     printf("Mayor a menor\n");
	     print(array);//imprime el arreglo desordenado
	     array=inserccion(array,0);//llamada de la función que ordena los números de mayor a menor
	     print(array);//imprime el arreglo ordenado
	     u=0;
	     break;
       case 2://está segunda opción permite ordenar los número de menor a mayor
	     printf("Menor a mayor\n");
	     print(array);//imprime el arreglo desordenado
	     array=inserccion1(array,0);//llamada de la función que ordena los números de menor a mayor
	     print(array);//imprime el arreglo ordenado
	     u=0;
	     break;
     case 3: cont=0;//está tercera opción permite al usuario volver al menú principal
